...
pub const y15d05 = @import("solvers/y15d05.zig");
pub const y15d06 = @import("solvers/y15d06.zig");
...
pub const y16d05 = @import("solvers/y16d05.zig");
pub const y16d06 = @import("solvers/y16d06.zig");
...
pub const y17d05 = @import("solvers/y17d05.zig");
pub const y17d06 = @import("solvers/y17d06.zig");
...
pub const y18d05 = @import("solvers/y18d05.zig");
pub const y18d06 = @import("solvers/y18d06.zig");
...
pub const List = [_]Solver{
    ...
    Solver{ .name = "y15d05", .func = y15d05.solve },
    Solver{ .name = "y15d06", .func = y15d06.solve },
    ...
    Solver{ .name = "y16d05", .func = y16d05.solve },
    Solver{ .name = "y16d06", .func = y16d06.solve },
    ...
    Solver{ .name = "y17d05", .func = y17d05.solve },
    Solver{ .name = "y17d06", .func = y17d06.solve },
    ...
    Solver{ .name = "y18d05", .func = y18d05.solve },
    Solver{ .name = "y18d06", .func = y18d06.solve },
